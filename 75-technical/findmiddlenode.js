...
class LinkedList {
    ...
    //                                      //
    findMiddleNode() {
      let speedTwo = this.head
      let speedOne = this.head

      while (speedTwo !== null && speedTwo.next !== null){
        //move jumper two positions as next position
        speedTwo = speedTwo.next.next
        //move slowjumper to next position at 
        speedOne = speedOne.next 
      }
      //i want the middle one which is gonna be half of the speedTwo; ie where speedOne is
      return speedOne
    }
    //                                      //
    //                                      //
